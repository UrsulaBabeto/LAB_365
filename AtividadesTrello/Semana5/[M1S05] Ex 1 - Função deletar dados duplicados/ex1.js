...
const array = ['Pedro', 'José', 'Aderbal', 'Danilo', 'Luisa', 'Vitoria',"Luisa", 'Luis', 'Danilo', 'José']


const names = array.filter((e, elemento) => {
    return array.indexOf(e) !== elemento;
});
console.log(names); 

const filtered = array.filter((e, elemento) => {
    return array.indexOf(e) === elemento;
});
